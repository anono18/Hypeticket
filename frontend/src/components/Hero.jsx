            ...
            <div className='relative h-[744px] w-full'>
                ...
                <div className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-full w-full'>
                    <div className='flex flex-col items-center justify-center h-full text-center z-10 relative top-1'>
                        <h4 className='uppercase medium-20 tracking-wider text-white'>FOR EVERY EVENT</h4>
                        <h2 className='h1 capitalize max-w-[40rem] text-white'>Book Your <span className='text-amber-600'>TICKET</span> Here!</h2>
                        ...
                        <div className='inline-flex items-center justify-center gap-4 p-2 bg-white rounded-xl'>
                            <div className='text-center regular-16 leading-tight pl-5'>
                                ...
                                <p className='regular-16'>For featured events</p>
                            </div>
                            <Link to='/events' className='btn-dark rounded-xl flexCenter !py-5 hover:text-secondary !border-black hover:bg-white'>Buy Ticket Now</Link>
                        </div>
                    </div>
                </div>
            </div>
